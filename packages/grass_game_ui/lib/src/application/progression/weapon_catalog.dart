...
const List<WeaponDefinition> grassGameWeaponCatalog = [
  WeaponDefinition(
    ...
    kind: "迫击炮",
    buyCost: 0,
    baseColorValue: 0xFFB6C2B9,
    country: "苏联",
    unlockMethod: "经验解锁",
    maxStars: 2,
    fireMode: "手动",
    fireRateRoundsPerMinute: 60,
    damage: 18,
    wikiImageUrl:
  ...
  WeaponDefinition(
    ...
    kind: "突击步枪",
    buyCost: 1035,
    baseColorValue: 0xFF4CC9F0,
    country: "苏联",
    unlockMethod: "付费小队",
    maxStars: 5,
    fireMode: "全自动,半自动",
    fireRateRoundsPerMinute: 660,
    damage: 6,
    wikiImageUrl:
  ...
  WeaponDefinition(
    ...
    kind: "栓动步枪",
    buyCost: 700,
    baseColorValue: 0xFFA7B5FF,
    country: "苏联",
    unlockMethod: "经验解锁",
    maxStars: 4,
    fireMode: "手动",
    fireRateRoundsPerMinute: 51,
    damage: 11,
    wikiImageUrl:
  ...
  WeaponDefinition(
    ...
    kind: "其他",
    buyCost: 295,
    baseColorValue: 0xFFB7C0C7,
    country: "苏联",
    unlockMethod: "活动",
    maxStars: 2,
    fireMode: "半自动",
    fireRateRoundsPerMinute: 360,
    damage: 5,
    wikiImageUrl:
  ...
  WeaponDefinition(
    ...
    kind: "火焰喷射器",
    buyCost: 560,
    baseColorValue: 0xFFFF6B6B,
    country: "苏联",
    unlockMethod: "经验解锁",
    maxStars: 3,
    fireMode: "全自动",
    fireRateRoundsPerMinute: 1200,
    damage: 5,
    wikiImageUrl:
  ...
  WeaponDefinition(
    id: "weapon_016",
    name: "莫辛-纳甘（“代尔可诺夫”枪榴弹发射器）",
    kind: "步枪&榴弹发射器",
    buyCost: 695,
    baseColorValue: 0xFF9BDEAC,
    country: "苏联",
    unlockMethod: "经验解锁",
    maxStars: 5,
    fireMode: "手动",
    fireRateRoundsPerMinute: 52,
    damage: 11,
    wikiImageUrl:
  ...
  WeaponDefinition(
    ...
    kind: "步兵用发射器",
    buyCost: 380,
    baseColorValue: 0xFFC6D8D3,
    country: "苏联",
    unlockMethod: "通行证",
    maxStars: 4,
    fireMode: "手动",
    fireRateRoundsPerMinute: 36,
    damage: 5,
    wikiImageUrl:
  ...
  WeaponDefinition(
    id: "weapon_038",
    name: "100式“铁拳”反坦克榴弹发射器",
    kind: "榴弹发射器",
    buyCost: 860,
    baseColorValue: 0xFFC084FC,
    country: "苏联",
    unlockMethod: "经验解锁",
    maxStars: 3,
    fireMode: "半自动",
    fireRateRoundsPerMinute: 42,
    damage: 14,
    wikiImageUrl:
  ...
  WeaponDefinition(
    ...
    kind: "霰弹枪",
    buyCost: 1215,
    baseColorValue: 0xFFFFA69E,
    country: "苏联",
    unlockMethod: "经验解锁",
    maxStars: 4,
    fireMode: "手动",
    fireRateRoundsPerMinute: 240,
    damage: 15,
    wikiImageUrl:
  ...
  WeaponDefinition(
    id: "weapon_099",
    name: "法夸尔·希尔M1918 文件:Farquhar hill 1918 gun.png",
    kind: "半自动步枪",
    buyCost: 815,
    baseColorValue: 0xFF7FDBFF,
    country: "美国",
