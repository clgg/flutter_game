...
class ProjectileVisualStyle {
  ...
  factory ProjectileVisualStyle.forKind(String kind) {
    return switch (kind) {
      ...
      'shadow_guard_azure' => const ProjectileVisualStyle(
          collisionRadius: 5,
          imageWidth: 32,
          imageHeight: 16,
          coreLength: 30,
          ...
          trailWidth: 4,
          glowRadius: 13,
          coreColor: ui.Color(0xFFE8FBFF),
          trailColor: ui.Color(0xFF7AD7FF),
          glowColor: ui.Color(0x663D8BFF),
        ),
      'shadow_guard_emerald' => const ProjectileVisualStyle(
          collisionRadius: 6,
          imageWidth: 36,
          imageHeight: 18,
          coreLength: 32,
          ...
          glowRadius: 12,
          coreColor: ui.Color(0xFFE8FFF2),
          trailColor: ui.Color(0xFF70E06B),
          glowColor: ui.Color(0x6632B86A),
        ),
      'shadow_guard_golden' => const ProjectileVisualStyle(
          collisionRadius: 7,
          imageWidth: 34,
          imageHeight: 20,
          coreLength: 28,
          ...
          trailWidth: 6,
          glowRadius: 14,
          coreColor: ui.Color(0xFFFFF1A6),
          trailColor: ui.Color(0xFFFFD36E),
          glowColor: ui.Color(0x66FF9F3D),
        ),
      'shadow_guard_silver' => const ProjectileVisualStyle(
          collisionRadius: 6,
          imageWidth: 40,
          imageHeight: 16,
          coreLength: 36,
          ...
          glowRadius: 11,
          coreColor: ui.Color(0xFFFFFFFF),
          trailColor: ui.Color(0xFFC7F7FF),
          glowColor: ui.Color(0x668FD7FF),
        ),
      'shadow_guard_violet' => const ProjectileVisualStyle(
          collisionRadius: 7,
          imageWidth: 36,
          imageHeight: 20,
          coreLength: 30,
